...
BasicSwapChain::BasicSwapChain(BasicDevice &deviceRef, VkExtent2D extent)
...
VkResult BasicSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult BasicSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                              uint32_t *imageIndex) {
...
void BasicSwapChain::createSwapChain() {
...
void BasicSwapChain::createImageViews() {
...
void BasicSwapChain::createDepthResources() {
...
VkSurfaceFormatKHR BasicSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR BasicSwapChain::chooseSwapPresentMode(
...
VkExtent2D
BasicSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat BasicSwapChain::findDepthFormat() {
